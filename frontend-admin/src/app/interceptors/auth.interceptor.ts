...
const excludedUrls = [
  `${GroupApiEnum.Admin}${AuthApiEnum.Register}`,
  `${GroupApiEnum.Admin}${AuthApiEnum.Login}`,
  `${GroupApiEnum.Admin}${AuthApiEnum.RefreshToken}`,
  `${GroupApiEnum.Admin}${AuthApiEnum.Logout}`,
];
